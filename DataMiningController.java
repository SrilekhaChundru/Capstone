...
public class DataMiningController {
    ...
    @GetMapping(produces = "application/json",path = "/allKeywords")
    public @ResponseBody List<AlgorithmData> getKeywords(@RequestParam  String crawlerId, int flag, String type){

        List<AlgorithmData> keywords= competitiveSeller.getCompetitorKeywords(crawlerId,flag,type);
        return keywords;
